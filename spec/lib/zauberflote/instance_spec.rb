...
describe Zauberflote::Instance  do
  ...
  describe 'concurrent instances' do
    ...
    it 'should have different instance attributes' do
      person_a.instance.wont_equal person_b.instance
    end
    it 'should have the same instances' do
      person_b.instance.must_equal instance_b
      person_a.instance.must_equal instance_a
    end
